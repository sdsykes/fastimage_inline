...
Gem::Specification.new do |s|
  ...
  s.files = ["Rakefile", "README", "README.textile", "VERSION.yml", "lib/fastimage_inline.rb", "test/app", "test/app/controllers", "test/app/controllers/main_controller.rb", "test/app/views", "test/app/views/main", "test/app/views/main/index.erb", "test/config", "test/config/boot.rb", "test/config/environment.rb", "test/config/environments", "test/config/environments/test.rb", "test/config/routes.rb", "test/log", "test/public", "test/public/images", "test/public/images/bg.png", "test/public/images/bullet.gif", "test/public/images/flag.jpg", "test/test.rb"]
